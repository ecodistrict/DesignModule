...
begin
  inherited Create(
    ...
    'default', aLegendJSON, '', aPalette, 0.10{every 10 seconds}, 10);
  tilerRefreshTime := 5;
end;
...
begin
  ...
  try
    ...
    begin
      if (scenario.clients.Count=0) and
...
begin
  ...
  begin
    ...
    if Assigned(scenario) and Assigned(scenario.Clients) and (scenario.clients.Count=0) then
    begin
