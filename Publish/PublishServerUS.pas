...
begin
  case fLayerType of
    ...
    21:  Result := stPOI; // POI
	  51:  Result := stGeometryCommonAndExtraPolygonsLR; // road color (VALUE_EXPR) and width (TEXTURE_EXPR) left and right
    52:  Result := stGeometryClassChangePolygonStripeLR; // road color (VALUE_EXPR) and width (TEXTURE_EXPR) left and right
  else
         Result := stUndefined;
  end;
end;
