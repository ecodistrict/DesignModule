...
// data['zonder_NL'] = {"casename":[["data zonder extra language"]],"id":["ssm"],"backgroundImages": [["odysa_map.jpg"]],"description":[[{"p":"Smart Traffic is the new generation resource for the road administators to monitor and evaluate the traffic efficiently in an effective way and let trafficlights control the traffic effective and connected."},{"p":"Smart Traffic delivers an intelligent way to control the traffic lights based on an integral traffic image based on a detection-information and floating car ."},{"hr":""}]],"casuslink":{"link":"../default.html","buttonText":[["Open case"]]},"partnersObject":{"name":[["Partners"]],"partners":[{"name":"Sweco","image":"partners_logo_sweco.jpg"}]},"simulationsObject":{"name":[["Simulation system"]],"simulations":[["OTS"],["Vissim"]]},"locationObject":{}};
...
data['ODYSA_INCAR'] = {"casename":[["ODYSA IN CAR"],{"NL":"ODYSA IN CAR"}],"id":["ODYSA_INCAR"],"backgroundImages":[["odysa_map.jpg"],{"src":"buttons_over.png","class":"overlay"}],"description":[[{"p":"ODYSA IN CAR is a dynamic green wave in the car that shows an advisory speed on a display with the required speed to get a green light at the next traffic light."},{"hr":""}],{"NL":[{"p":"ODYSA IN CAR is een dynamische groene golf in de auto waarbij op een display wordt een adviessnelheid wordt weergegeven die aangeeft hoe hard gereden moet worden om bij het volgende verkeerslicht groen te krijgen."},{"hr":""}]}],"casuslink":{"link":"../default.html?session=dtv","buttonText":[["Open case"],{"NL":"Open casus"}]},"partnersObject":{"name":[["Partners"],{"NL":"Partners"}],"partners":[{"name":"DTV Consultants","image":"partners_logo_dtv.png"},{"name":" PTV Group","image":"partners_ptv-group.jpg"}]},"simulationsObject":{"name":[["Simulation system"],{"NL":"Simulatie omgeving"}],"simulations":[["Vissim"]]},"locationObject":{"name":[["Location"],{"NL":"Locatie"}],"location":[["Eindhoven: Eisenhowerlaan, Insulindelaan and Onze‐Lieve‐Vrouwestraat"],{"NL":"Eindhoven: Eisenhowerlaan, Insulindelaan en Onze‐Lieve‐Vrouwestraat"}]}};
data['JUNO'] = {"casename":[["JUNO on the N470"],{"NL":"JUNO op de N470"}],"id":["JUNO"],"backgroundImages":[["Juno_map.jpg"],{"src":"buttons_over.png","class":"overlay"}],"description":[[{"p":"JUNO is an algorithm which improves traffic conditions at intersections. On average, JUNO reduces the delay at intersections by 20%. This 20% reduction is the result of a great number of simulation studies and confirmed in field operational tests."},{"hr":""}],{"NL":[{"p":"JUNO is een algoritme waarmee de verkeersafwikkeling op kruispunten kan worden verbeterd. Over het algemeen vermindert de inzet van JUNO de vertraging op een kruispunt met zo’n 20%. Dit effect is aangetoond in een groot aantal simulatiestudies en bevestigd in veldtesten."},{"hr":""}]}],"casuslink":{"link":"../default.html?session=juno","buttonText":[["Open case"],{"NL":"Open casus"}]},"partnersObject":{"name":[["Partners"],{"NL":"Partners"}],"partners":[{"name":"TNO","image":"logo_tno_groot.png"},{"name":" PTV Group","image":"partners_ptv-group.jpg"}]},"simulationsObject":{"name":[["Simulation system"],{"NL":"Simulatie omgeving"}],"simulations":[["Vissim"]]},"locationObject":{"name":[["Location"],{"NL":"Locatie"}],"location":[["N470"],{"NL":"N470"}]}};
data['cacc'] = {"casename":[["CACC and shockwaves on the A58"],{"NL":"CACC en schokgolven op de A58"}],"id":["a58"],"backgroundImages":[["Cacc_map.jpg"],{"src":"buttons_over.png","class":"overlay"}],"description":[[{"p":"CACC is a system whereby predecessors can be followed on short distances. So the intensity can be higher without commencing shockwaves. If they do commence, the CACC is better capable than humans to solve the shockwaves at the front of the shockwave. CACC leaves the shockwaves more efficently."},{"hr":""}],{"NL":[{"p":"CACC is een systeem waarmee voorgangers op korte afstanden kunnen worden gevolgd. Zodoende kan de intensiteit hoger zijn zonder dat er schokgolven ontstaan. Als deze wel ontstaan, is CACC beter in staat dan bestuurders om de schokgolven aan de voorkant op te lossen. CACC verlaat de schokgolf op een efficiëntere wijze."},{"hr":""}]}],"casuslink":{"link":"../default.html?session=tud","buttonText":[["Open case"],{"NL":"Open casus"}]},"partnersObject":{"name":[["Partners"],{"NL":"Partners"}],"partners":[{"name":"TU Delft","image":"partners_logo_tudelft.png"}]},"simulationsObject":{"name":[["Simulation system"],{"NL":"Simulatie omgeving"}],"simulations":[["OTS"]]},"locationObject":{"name":[["Location"],{"NL":"Locatie"}],"location":[["A58 between Tilburg and Eindhoven"],{"NL":"a58 tussen Tilburg en Eindhoven"}]}};
data['A2'] = {"casename":[["CACC on the A2"],{"NL":"CACC op de A2"}],"id":["a2"],"backgroundImages":[["A2_map.jpg"],{"src":"buttons_over.png","class":"overlay"}],"description":[[{"p":"CACC is a system whereby predecessors can be followed on short distances. So the intensity can be higher without commencing shockwaves. If they do commence, the CACC is better capable than humans to solve the shockwaves at the front of the shockwave. CACC leaves the shockwaves more efficently."},{"hr":""}],{"NL":[{"p":"CACC is een systeem waarmee voorgangers op korte afstanden kunnen worden gevolgd. Zodoende kan de intensiteit hoger zijn zonder dat er schokgolven ontstaan. Als deze wel ontstaan, is CACC beter in staat dan bestuurders om de schokgolven aan de voorkant op te lossen. CACC verlaat de schokgolf op een efficiëntere wijze."},{"hr":""}]}],"casuslink":{"link":"../default.html?session=a2","buttonText":[["Open case"],{"NL":"Open casus"}]},"partnersObject":{"name":[["Partners"],{"NL":"Partners"}],"partners":[{"name":"TNO","image":"logo_tno_groot.png"},{"name":" PTV Group","image":"partners_ptv-group.jpg"},{"name":" Studio Bereikbaar","image":"logo-studio-bereikbaar.png"}]},"simulationsObject":{"name":[["Simulation system"],{"NL":"Simulatie omgeving"}],"simulations":[["Vissim"]]},"locationObject":{"name":[["Location"],{"NL":"Locatie"}],"location":[["A2"],{"NL":"A2"}]}};
data['ssm'] = {"casename":[["Smart Traffic with floating car data"],{"NL":"Smart Traffic met floating car data"}],"id":["ssm"],"backgroundImages":[["odysa_map.jpg"],{"src":"buttons_over.png","class":"overlay"}],"description":[[{"p":"Smart Traffic is an innovative tool for road administators to monitor traffic and to evaluate overall network performance. A comprehensive insight into the actual traffic state is obtained by combining detector data with floating car data. This is used by Smart Traffic to provide intelligent traffic light control. Real-time, connected and effective."},{"hr":""}],{"NL":[{"p":"Smart Traffic is een innovatieve tool die door wegbeheerders gebruikt kan worden om verkeer te monitoren en de prestatie van het netwerk te evalueren. Een integraal verkeersbeeld wordt verkregen door detectie-informatie slim te combineren met floating car data. Op basis hiervan verzorgt Smart Traffic een intelligente aansturing van verkeerslichten. Real-time, connected en effectief."},{"hr":""}]}],"casuslink":{"link":"../default.html?session=sweco","buttonText":[["Open case"],{"NL":"Open casus"}]},"partnersObject":{"name":[["Partners"],{"NL":"Partners"}],"partners":[{"name":"Sweco","image":"partners_logo_sweco.png"},{"name":" PTV Group","image":"partners_ptv-group.jpg"}]},"simulationsObject":{"name":[["Simulation system"],{"NL":"Simulatie omgeving"}],"simulations":[["Vissim"]]},"locationObject":{"name":[["Location"],{"NL":"Locatie"}],"location":[["Eindhoven: Eisenhowerlaan, Insulindelaan and Onze‐Lieve‐Vrouwestraat"],{"NL":"Eindhoven: eisenhowerlaan, Insulindelaan en Onze‐Lieve‐Vrouwestraat"}]}};
