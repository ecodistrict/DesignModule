...
(function (factory) {
    ...
    L.Map.ContextMenu = L.Handler.extend({
        ...
        addHooks: function () {
            L.DomEvent
                // todo: work-a-round for ie11 see leaflet.contextmenu issues  .on(document, (L.Browser.touch ? this._touchstart : 'mousedown'), this._onMouseDown, this)
    ...
    L.Mixin.ContextMenu = {
        ...
        _hideContextMenu: function (event) {
            var i, l;
            if (this._map.contextmenu) {
                for (i = 0, l = this._items.length; i < l; i++) {
