 ...
 */
    ...
    L.Draw.Polyline = L.Draw.Feature.extend({
        ...
        _finishShape: function (e) {
            DataManager.event = e.originalEvent; // added 7-11-201 for firefox by Jasper Huting *adjusted 8-11 by Niek Knoop
        ...
        _updateFinishHandler: function (e) {
    ...
    L.Draw.Circle = L.Draw.SimpleShape.extend({
        ...
        _drawShape: function (latlng) {
            if (!this._shape) {
                ...
                //this._shape.options.color = this.options.shapeOptions.color; // todo: changed  by HC to above call goes wrong, distance is processed as options
                this._map.addLayer(this._shape);
            } else {
        ...
        _fireCreatedEvent: function () {
            // todo: var circle = new L.Circle(this._startLatLng, this._shape.getRadius(), this.options.shapeOptions);
