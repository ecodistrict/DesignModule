var UnitConverter = {
    ...
    ConvNum: function(aQnt, aValue, aUnit)
    {
        ...
        else
        {
            ...
            this.Subtract = function (aConvNum) {
                if (this.qnt != aConvNum.qnt)
            ...
            this.Multiply = function (aConvNum) {
                if (this.qnt != aConvNum.qnt)
            ...
            this.LesserEqual = function (aConvNum) {
                if (this.qnt != aConvNum.qnt)
            ...
            this.BiggerEqual = function (aConvNum) {
                if (this.qnt != aConvNum.qnt)
                    throw "Can't check lesser for ConvNum of different quantities";
                else
                    return this.value >= aConvNum.value;
