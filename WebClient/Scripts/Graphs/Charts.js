...
//        graphObject.bindto = graph.svg;
//        graphObject.size = { height: height - marginTop, width: width - marginRight };
//        graphObject.tooltip = { grouped: false };
//        graphObject.legend = { show: graphObject.showLegends };
//        graphObject.gauge = {
//            label: {
...
//        graph.chart = c3.generate(graphObject);
...
function Chart(graphObject) {
    ...
    this.Update = function (data) {
        ...
        if (data && data.columns)
            this.graphObject.data.columns = data.columns;
